...
const s = {
  ...
  barLabel:    { fontSize: 11, color: "#475569", letterSpacing: "0.1em", textAlign: "right" },
  nav:         { position: "relative", zIndex: 1, display: "flex", padding: "6px 14px", gap: 6 },
  navBtn:      { flex: 1, padding: "8px 0", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 7, background: "transparent", color: "#475569", fontSize: 11, letterSpacing: "0.15em", fontWeight: 700, cursor: "pointer", fontFamily: "'DM Mono',monospace" },
  navOn:       { background: "rgba(14,165,233,0.12)", borderColor: "rgba(14,165,233,0.4)", color: "#38bdf8" },
  grid:        { position: "relative", zIndex: 1, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, padding: "4px 8px 8px" },
  col:         { background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14, padding: "10px 8px", transition: "border-color 0.3s" },
  ...
  colName:     { fontSize: 16, fontWeight: 800, color: "#f1f5f9", letterSpacing: "0.04em" },
  colScore:    { fontSize: 13, color: "#64748b" },
  ...
  rName:       { fontSize: 12, color: "#cbd5e1", fontWeight: 600, letterSpacing: "0.04em" },
  rSub:        { fontSize: 11, color: "#475569", marginTop: 1 },
  check:       { fontSize: 14, color: "#334155", minWidth: 14, textAlign: "right" },
  ...
  notePh:      { fontSize: 11, color: "#2d3f55" },
  ...
  wComplete:   { marginLeft: "auto", fontSize: 12, color: "#22c55e", fontWeight: 800, letterSpacing: "0.1em" },
  wOz:         { marginLeft: "auto", fontSize: 13, color: "#38bdf8", fontWeight: 700 },
  wGoal:       { fontSize: 11, color: "#475569" },
  ...
  wBtn:        { flex: 1, padding: "6px 0", borderRadius: 6, background: "rgba(14,165,233,0.12)", border: "1px solid rgba(14,165,233,0.25)", color: "#38bdf8", fontSize: 11, fontWeight: 700, cursor: "pointer", fontFamily: "'DM Mono',monospace" },
  wMinus:      { padding: "6px 6px", borderRadius: 6, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", color: "#475569", fontSize: 11, fontWeight: 700, cursor: "pointer", fontFamily: "'DM Mono',monospace" },
  wLocked:     { fontSize: 11, color: "#22c55e", textAlign: "center", paddingTop: 3, letterSpacing: "0.05em" },
