...
const s = {
  ...
  colScore:    { fontSize: 13, color: "#94a3b8" },
  ...
  rSub:        { fontSize: 11, color: "#94a3b8", marginTop: 1 },
  ...
  wMinus:      { padding: "6px 6px", borderRadius: 6, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", color: "#94a3b8", fontSize: 11, fontWeight: 700, cursor: "pointer", fontFamily: "'DM Mono',monospace" },
